...
set_target_properties(SSSVRecompiled PROPERTIES
        MACOSX_BUNDLE TRUE
        MACOSX_BUNDLE_BUNDLE_NAME "SSSVRecompiled"
        MACOSX_BUNDLE_GUI_IDENTIFIER "com.github.sssvrecompiled"
...
target_sources(SSSVRecompiled PRIVATE ${ICNS_FILE})

# Ensure SSSVRecompiled depends on create_icns
add_dependencies(SSSVRecompiled create_icns)

# Configure Info.plist
configure_file(${CMAKE_SOURCE_DIR}/.github/macos/Info.plist.in ${CMAKE_BINARY_DIR}/Info.plist @ONLY)

# Install the app bundle
install(TARGETS SSSVRecompiled BUNDLE DESTINATION .)
...
add_custom_command(TARGET SSSVRecompiled POST_BUILD
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_BINARY_DIR}/temp_assets $<TARGET_BUNDLE_DIR:SSSVRecompiled>/Contents/Resources/assets
    COMMAND ${CMAKE_COMMAND} -E remove_directory ${CMAKE_BINARY_DIR}/temp_assets

    # Copy controller database
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/recompcontrollerdb.txt $<TARGET_BUNDLE_DIR:SSSVRecompiled>/Contents/Resources/

    # Set RPATH
    COMMAND install_name_tool -add_rpath "@executable_path/../Frameworks/" $<TARGET_BUNDLE_DIR:SSSVRecompiled>/Contents/MacOS/SSSVRecompiled

    # Sign the bundle
    COMMAND codesign --verbose=4 --options=runtime --no-strict --sign - --entitlements ${ENTITLEMENTS_FILE} --deep --force $<TARGET_BUNDLE_DIR:SSSVRecompiled>
